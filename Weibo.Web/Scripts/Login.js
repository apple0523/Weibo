...
var errorHtml = "<div id='mod_login_tip' style=\"display:none;\" class='errorLayer'><div class='top'></div><div class='mid'><div id='mod_login_close' class='close'>x</div><div class='conn'>	<p id='mod_login_title' class='bigtxt'></p><span style='padding: 0px; display: none;' id='mod_login_content' class='stxt'></span></div></div><div class='bot'></div></div>";
var checkLogin = function () {
    ...
    if (App.request("BackUrl") != "") {
        var action = $("#loginForm").attr("action");
        action += ("/?BackUrl=" + App.request("BackUrl"));
